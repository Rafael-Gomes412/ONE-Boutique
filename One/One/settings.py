...
SECRET_KEY = 'django-insecure-#6ilw+%x)hnw3184gosq-9+j#$v)!a9doen#cx2*zxu9zmtu_!'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR/ "static")]  # Utiliser BASE_DIR pour spécifier le chemin complet
